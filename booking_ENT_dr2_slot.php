...
<form style="text-align: center;" method="post">
    ...
    <div class="date">
      ...
      <input placeholder="Choose a date" type="text" onfocus="(this.type='date')" min="2020-04-13" max="2020-04-14" name="date" required>
    ...
    <div class="time">
      ...
      <label for="start">Booking time:</label>
        ...
        <select name="time" required>
          ...
          <option class="opt" value="9:00 am - 10:00 am">9:00 am - 10:00 am</option>
          
          <option class="opt" value="6:00 pm - 7:00 pm">6:00 pm - 7:00 pm</option>
