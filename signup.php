...
<?php endif ?>
    ...
    <input type="number" placeholder="Enter Age" name="age" min="1" max="100" required>
    <br>

    <label for="height"><b>Height (in cms)</b></label><br>
    <input type="number" placeholder="Enter Height" name="height" required>
    <br>

    <label for="weight"><b>Weight (in kgs)</b></label><br>
