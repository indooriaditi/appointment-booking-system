...
<form style="text-align: center;" method="post">
    ...
    <div class="date">
      ...
      <input placeholder="Choose a date" type="text" onfocus="(this.type='date')" min="2020-03-29" max="2020-03-30" name="date" required>
    ...
    <div class="time">
      ...
      <label for="start">Booking time:</label>
        ...
        <select name="time" required>
          ...
          <option class="opt" value="11:00 am - 12:00 pm">11:00 am - 12:00 pm</option>
          
          <option class="opt" value="4:00 pm - 5:00 pm">4:00 pm - 5:00 pm</option>
