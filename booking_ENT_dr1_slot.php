...
<form style="text-align: center;" method="post">
    ...
    <div class="date">
      ...
      <input placeholder="Choose a date" type="text" onfocus="(this.type='date')" min="2020-04-10" max="2020-04-11" name="date" required>
    ...
    <div class="time">
      ...
      <label for="start">Booking time:</label>
        ...
        <select name="time" required>
          ...
          <option class="opt" value="10:00 am - 12:00 pm">10:00 am - 12:00 pm</option>
          
          <option class="opt" value="4:00 pm - 6:00 pm">4:00 pm - 6:00 pm</option>
