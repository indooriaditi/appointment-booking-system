...
<div class="ProfileItem">
    ...
    <div class="ProfileDes">
        <a class="profileTitle">Dr.Harika</a>
        <br><br>
        <div class="profileInfo">Specialization: Paediatrics</div>
        <div class="profileInfo">Qualification: MBBS, DCS(Paediatrics)</div>
        <div class="profileInfo">Experience: 17 yrs</div>
        <div class="profileInfo">Languages: English, Telugu, Tamil</div>
    </div>
  
  <br>
    
    <form method="post">
        <input type="hidden" name="dr" value="Dr.Harika">
...
<div class="ProfileItem">
    ...
    <div class="ProfileDes">
        <a class="profileTitle">Dr.Chandra Mohan</a>
        <br><br>
        <div class="profileInfo">Specialization: Paediatrics</div>
        <div class="profileInfo">Qualification: MBBS, MRCPCH(UK)</div>
        <div class="profileInfo">Experience: 19 yrs</div>
  ...
  <br>
    ...
    <form method="post">
        <input type="hidden" name="dr" value="Dr.Chandra Mohan">
